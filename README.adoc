...
that then get used by a JRE, one comes with the JDK].
...
different editions of the JDK, only the Standard Edition (Java SE) is necesary not the much bigger Enterprise Edition (Java EE).
...
==== 3. Downloand and build the Chats App.
