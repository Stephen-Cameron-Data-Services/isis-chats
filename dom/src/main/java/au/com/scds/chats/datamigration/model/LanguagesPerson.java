...
/**
 * The persistent class for the languages_persons database table.
 * 
 */
@Entity
@Table(name="languages_persons")
public class LanguagesPerson implements Serializable {
