...
/**
 * The persistent class for the scheduleelementtypes database table.
 * 
 */
@Entity
@Table(name="scheduleelementtypes")
public class Scheduleelementtype implements Serializable {
