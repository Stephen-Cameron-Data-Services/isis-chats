...
/**
 * The persistent class for the schedulerecurrancepatterns database table.
 * 
 */
@Entity
@Table(name="schedulerecurrancepatterns")
public class Schedulerecurrancepattern implements Serializable {
	...
	public Schedulerecurrancepattern() {
	}
