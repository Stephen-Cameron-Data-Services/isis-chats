...
@DomainService(repositoryFor = TransportHub.class, nature = NatureOfService.DOMAIN)
@DomainServiceLayout(menuBar = MenuBar.SECONDARY, named = "Administration", menuOrder = "100.9")
public class TransportHubs {

	public List<TransportHub> listAllTransportHubs() {
		List<TransportHub> hubs = repositoryService
				.allMatches(new QueryDefault<>(TransportHub.class, "findAllTransportHubs"));
		return hubs;
	}

	public List<TransportHub> listAllNamedTransportHubs() {
		List<TransportHub> hubs = repositoryService
				.allMatches(new QueryDefault<>(TransportHub.class, "findAllNamedTransportHubs"));
		return hubs;
	}
