...
@DomainObject(
        objectType = "NoteLinkableLinkForRecurringActivity"
)
public class NoteLinkableLinkForRecurringActivity extends NoteLinkableLink {
    ...
    public static class InstantiationSubscriber extends AbstractSubscriber {
        ...
        public void on(final InstantiateEvent ev) {
            if(ev.getPolymorphicReference() instanceof RecurringActivity) {
                ev.setSubtype(NoteLinkableLinkForRecurringActivity.class);
            }
        }
    }
