...
@DomainObject(
        objectType = "NoteLinkableLinkForScheduledCall"
)
public class NoteLinkableLinkForScheduledCall extends NoteLinkableLink {
    ...
    public static class InstantiationSubscriber extends AbstractSubscriber {
        ...
        public void on(final InstantiateEvent ev) {
            if(ev.getPolymorphicReference() instanceof ScheduledCall) {
                ev.setSubtype(NoteLinkableLinkForScheduledCall.class);
            }
        }
    }
