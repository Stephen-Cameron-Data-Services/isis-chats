...
@DomainObject(
        objectType = "NoteLinkableLinkForVolunteer"
)
public class NoteLinkableLinkForVolunteer extends NoteLinkableLink {
    ...
    public static class InstantiationSubscriber extends AbstractSubscriber {
        ...
        public void on(final InstantiateEvent ev) {
            if(ev.getPolymorphicReference() instanceof Volunteer) {
                ev.setSubtype(NoteLinkableLinkForVolunteer.class);
            }
        }
    }
