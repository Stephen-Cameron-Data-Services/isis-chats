...
@DomainObject(
        objectType = "NoteLinkablePrimaryLinkForActivityEvent"
)
public class NoteLinkablePrimaryLinkForActivityEvent extends NoteLinkablePrimaryLink {
    ...
    public static class InstantiationSubscriber extends AbstractSubscriber {
        ...
        public void on(final InstantiateEvent ev) {
            if(ev.getPolymorphicReference() instanceof ActivityEvent) {
                ev.setSubtype(NoteLinkablePrimaryLinkForActivityEvent.class);
            }
        }
    }
