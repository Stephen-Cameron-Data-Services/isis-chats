...
@DomainObject(
        objectType = "NoteLinkablePrimaryLinkForParticipant"
)
public class NoteLinkablePrimaryLinkForParticipant extends NoteLinkablePrimaryLink {
    ...
    public static class InstantiationSubscriber extends AbstractSubscriber {
        ...
        public void on(final InstantiateEvent ev) {
            if(ev.getPolymorphicReference() instanceof Participant) {
                ev.setSubtype(NoteLinkablePrimaryLinkForParticipant.class);
            }
        }
    }
