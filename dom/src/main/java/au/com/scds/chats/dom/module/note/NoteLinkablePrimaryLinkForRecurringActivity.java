...
@DomainObject(
        objectType = "NoteLinkablePrimaryLinkForRecurringActivity"
)
public class NoteLinkablePrimaryLinkForRecurringActivity extends NoteLinkablePrimaryLink {
    ...
    public static class InstantiationSubscriber extends AbstractSubscriber {
        ...
        public void on(final InstantiateEvent ev) {
            if(ev.getPolymorphicReference() instanceof RecurringActivity) {
                ev.setSubtype(NoteLinkablePrimaryLinkForRecurringActivity.class);
            }
        }
    }
    ...
    private RecurringActivity activity;
    ...
    public void setRecurringActivity(final RecurringActivity activity) {
