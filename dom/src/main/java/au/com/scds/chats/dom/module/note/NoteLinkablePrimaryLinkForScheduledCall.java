...
@DomainObject(
        objectType = "NoteLinkablePrimaryLinkForScheduledCall"
)
public class NoteLinkablePrimaryLinkForScheduledCall extends NoteLinkablePrimaryLink {
    ...
    public static class InstantiationSubscriber extends AbstractSubscriber {
        ...
        public void on(final InstantiateEvent ev) {
            if(ev.getPolymorphicReference() instanceof ScheduledCall) {
                ev.setSubtype(NoteLinkablePrimaryLinkForScheduledCall.class);
            }
        }
    }
