...
public class StaffMembers {
    ...
    public List<StaffMember> listAll() {
        return container.allInstances(StaffMember.class);
    }
    //endregion
    ...
    public List<StaffMember> findByName(
    ...
    public StaffMember create(
        ...
        final StaffMember obj = container.newTransientInstance(StaffMember.class);
        obj.setName(name);
