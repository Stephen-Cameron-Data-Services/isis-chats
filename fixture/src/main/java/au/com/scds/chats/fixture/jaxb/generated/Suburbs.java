...
/**
 * <p>Java class for Suburbs complex type.
 * 
...
@XmlType(name = "Suburbs", propOrder = {
    "suburb"
})
public class Suburbs {

    @XmlElement(required = true)
    protected List<Suburbs.Suburb> suburb;
     ...
     * 
     */
    public List<Suburbs.Suburb> getSuburb() {
        if (suburb == null) {
            suburb = new ArrayList<Suburbs.Suburb>();
        }
        return this.suburb;
    }
