 ...
 *  under the License.
 */
package au.com.scds.isis.integtests.bootstrap;
...
public class SimpleAppSystemInitializer extends IntegrationTestAbstract {
    ...
    private static class SimpleAppSystemBuilder extends IsisSystemForTest.Builder {
        ...
        public SimpleAppSystemBuilder() {
            ...
            withServicesIn( "au.com.scds.isis" );
        }

        private static IsisConfiguration testConfiguration() {
            final IsisConfigurationForJdoIntegTests testConfiguration = new IsisConfigurationForJdoIntegTests();

            testConfiguration.addRegisterEntitiesPackagePrefix("au.com.scds.isis.dom.modules");
