...
@PersistenceCapable(identityType = IdentityType.NONDURABLE, table = "ActivityParticipantAttendanceFromDexData", extensions = {
		@Extension(vendorName = "datanucleus", key = "view-definition", value = "CREATE VIEW ActivityParticipantAttendanceFromDexData "
				...
				+ "  dexdata.title AS activity, " + "  dexdata.date AS date, " + "  dexdata.minutes AS minutes, "
...
@Queries({
		@Query(name = "allActivityParticipantAttendance", language = "JDOQL", value = "SELECT FROM au.com.scds.chats.dom.report.view.ActivityParticipantAttendanceFromDexData"),
		@Query(name = "allParticipantActivityForPeriodAndRegion", language = "JDOQL", value = "SELECT FROM au.com.scds.chats.dom.report.view.ActivityParticipantAttendanceFromDexData pa "
				+ "WHERE pa.date >= :startDate && pa.date <= :endDate && pa.regionName == :region"), })
@Inheritance(strategy = InheritanceStrategy.NEW_TABLE)
public class ActivityParticipantAttendanceFromDexData {
