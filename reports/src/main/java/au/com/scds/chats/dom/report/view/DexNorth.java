...
@PersistenceCapable(identityType = IdentityType.NONDURABLE, table = "DexNorth", extensions = {
		@Extension(vendorName = "datanucleus", key = "view-definition", value = "CREATE VIEW DexNorth  ( "
...
@Queries({
		@Query(name = "allInPeriod", language = "JDOQL", value = "SELECT FROM au.com.scds.chats.dom.report.view.DexNorth pa "
				+ "WHERE pa.interactiondate >= :startDateTime && pa.interactiondate <= :endDateTime"), })
@Inheritance(strategy = InheritanceStrategy.NEW_TABLE)
public class DexNorth /* implements WithApplicationTenancy */ implements Comparable<DexNorth> {
	...
	@Override
	public int compareTo(DexNorth o) {
