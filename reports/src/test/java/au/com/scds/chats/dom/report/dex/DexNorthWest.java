...
public class DexNorthWest extends IntegrationTestAbstract {
	...
	public void DEXNorthWestJan() throws Exception {
		...
		FileWriter writer = new FileWriter(new File(DIR + "DEXBulkUploadNORTH-WEST-JAN2016.xml"));
	...
	public void DEXNorthWestFeb() throws Exception {
		...
		String DIR = new String("C:/Users/stevec/Desktop/dex/reports/");
		FileWriter writer = new FileWriter(new File(DIR + "DEXBulkUploadNORTH-WEST-FEB2016.xml"));
	...
	public void DEXNorthWestMar() throws Exception {
		...
		String DIR = new String("C:/Users/stevec/Desktop/dex/reports/");
		FileWriter writer = new FileWriter(new File(DIR + "DEXBulkUploadNORTH-WEST-MAR2016.xml"));
	...
	public void DEXNorthWestApr() throws Exception {
		...
		String DIR = new String("C:/Users/stevec/Desktop/dex/reports/");
		FileWriter writer = new FileWriter(new File(DIR + "DEXBulkUploadNORTH-WEST-APR2016.xml"));
	...
	public void DEXNorthWestMay() throws Exception {
		...
		String DIR = new String("C:/Users/stevec/Desktop/dex/reports/");
		FileWriter writer = new FileWriter(new File(DIR + "DEXBulkUploadNORTH-WEST-MAY2016.xml"));
	...
	@Test
	public void DEXNorthWestJune() throws Exception {
		
		String DIR = new String("C:/Users/stevec/Desktop/dex/reports/");
		FileWriter writer = new FileWriter(new File(DIR + "DEXBulkUploadNORTH-WEST-JUNE2016.xml"));
		DEXNorthWestReport report1 = new DEXNorthWestReport( repository, isisJdoSupport,  participants, 2016, 6, "NORTH-WEST");
		JAXBContext context = JAXBContext.newInstance(DEXFileUpload.class);
		Marshaller marshaller = context.createMarshaller();
		marshaller.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, Boolean.TRUE);
		//suppress the xml header so can add own
